...
class QuickAddObservationScreen extends StatefulWidget {
  const QuickAddObservationScreen({super.key});
...
class _QuickAddObservationScreenState extends State<QuickAddObservationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Szybki Zapis Okazu"), backgroundColor: Colors.green.shade700, foregroundColor: Colors.white),
      body: SafeArea(
  ...
  void _handleQuickSave() async {
    ...
    final newObs = PlantObservation(
      ...
      timestamp: DateTime.now(), observationDate: DateTime.now(), // Od razu kompletna!
